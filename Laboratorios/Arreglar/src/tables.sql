...
CREATE TABLE IF NOT EXISTS Degrees(
	degreeId INT NOT_NULL AUTOINCREMENT,
	name VARCHAR(60) NOT_NULL UNIQUE(),
	years INT NOT_NULL DEFAULT(4),
	PRIMARY KEY degreeId,
	CONSTRAINT invalidDegreeYear (years>=3 AND years <=5),
);

CREATE TABLE IF NOT EXISTS Subjects(
	subjectId INT NOT NULL AUTO INCREMENT,
	...
	FOREIGN KEY degreeId REFERENCES Degrees degreId ON DELETE CASCADE,
...
CREATE TABLE GroupsStudents
	...
	FOREIGN_KEY (groupId) REFERENCES Gorups (groupId),
	FOREIGN_KEY (studentId) REFERENCES Students (studentId),
...
CREATE TABLE Grades(
	...
	FOREIGN KEY (gorupId) REFERENCES Groups (groupId),
