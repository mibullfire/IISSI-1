...
INSERT INTO Subjects (subjectId, name, acronim, credits, year, type, degreeId) VALUES
	(1, 'Diseño y Pruebas', 'DP', 12, 5, 'Obligatoria', 1),
	(2, 'Acceso Inteligente a la Informacion', 'AII', 6, 4, 'Optattiva', 1)
	(3, 'Optimizacion de Sistemas', 'OS', 6, 4, 'Optativa', 1),
	(4, 'Ingeniería de Requisitos', 'IR', 6, 2, 'Obligatoria', 7),
...
INSERT INTO Groups (groupId, name, activity, subjectId) VALUES
	(1, 'T1', 'Teoria', 2018, 1),
	(2, 'T2', 'Teoria', 2018, 1),
...
INSERT INTO Students (studentId, accessMethod, dni, firstname, surname, birthdate, email) VALUES
	...
	(7, 'Selectividad', '723455678A', 'Azael', 'González', 1997/01/01, 'azael@alum.us.es'),
	(8, 'Selectividad', '8345678A', 'Uriel', 'Martínez', 1998/01/01, 'uriel@alum.us.es'),
	(9, 'Selectividad', '92345678A', 'Gael', 'Sánchez', 1999/01/13, 'gael@alum.us.es'),
	...
	(17, 'Titulado Extanjero', '82345678B', 'Baraquiel', 'Ibáñez', 1998/02/02, 'baraquiel@alum.us.es'),
